            ...
            <div class="container-fluid">
                ...
                <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                    <div class="row g-4">
                        <div class="col-auto">
                            <div class="avatar-lg">
                                <img src="{{asset('backend/assets/images/users/avatar-1.jpg')}}" alt="user-img" class="img-thumbnail rounded-circle" />
                            </div>
                        </div>
                        <!--end col-->
                        <div class="col">
                            <div class="p-2">
                                ...
                                <p class="text-white text-opacity-75">{{ Auth::user()->username }}</p>
                                <div class="hstack text-white-50 gap-1">
                                    ...
                                    <div>
                                        <i class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ Auth::user()->role }}
                                    </div>
                                </div>
                            </div>
                        </div>
